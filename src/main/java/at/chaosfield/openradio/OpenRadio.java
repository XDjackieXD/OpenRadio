...
@Mod(name = "Open Radio", modid = OpenRadio.MODID, version = "0.2", modLanguage = "java", dependencies = "required-after:OpenComputers@[1.5.0,);required-after:appliedenergistics2")
