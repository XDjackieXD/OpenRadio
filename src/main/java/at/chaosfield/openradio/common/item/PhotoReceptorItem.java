...
public class PhotoReceptorItem extends Item{
    ...
    {
        icons = new IIcon[3];
        icons[0] = par1IconRegister.registerIcon(OpenRadio.MODID + ":photoreceptort1");
        icons[1] = par1IconRegister.registerIcon(OpenRadio.MODID + ":photoreceptort2");
        icons[2] = par1IconRegister.registerIcon(OpenRadio.MODID + ":photoreceptort3");
    }
